...
import mjml2html, { components, initializeType } from '@sherweb/mjml-core'
import migrate from '@sherweb/mjml-migrate'
import validate, { dependencies } from '@sherweb/mjml-validator'
import MJMLParser from '@sherweb/mjml-parser-xml'

import { version as coreVersion } from '@sherweb/mjml-core/package.json'
